                                                            ...
                                                            products.forEach((p, i) => {
                                                                html += `
                                                                      <div class="product">
                                                                              <div>
                                                                                        <h3>${p.name}</h3>
                                                                                                  <div class="old">₹${p["regular price"]}</div>
                                                                                                            <div class="new">₹${p["offer price"]}/kg</div>
                                                                                                                    </div>

                                                                                                                            <div>
                                                                                                                                      <button onclick="changeQty(${i},-1)">−</button>
                                                                                                                                                <b style="padding:10px">${qtyText(p.qty)}</b>
                                                                                                                                                          <button onclick="changeQty(${i},1)">+</button>
                                                                                                                                                                  </div>
                                                                                                                                                                        </div>
                                                                                                                                                                            `;
                                                                                                  ...
                                                                                                  let msg = "*🥬 NSI VEGETABLES ORDER*%0A%0A";
                                                                                                    ...
                                                                                                    products.forEach(p => {
                                                                                                        ...
                                                                                                        if (p.qty > 0) {
                                                                                                              ...
                                                                                                              msg += `${p.name} - ${qtyText(p.qty)} - ₹${(p.qty * Number(p["offer price"])).toFixed(2)}%0A`;
                                                                                                                        ...
                                                                                                                        msg += `%0A%0A👤 Name : ${document.getElementById("name").value}`;
                                                                                                                          msg += `%0A📞 Phone : ${document.getElementById("phone").value}`;
                                                                                                                            msg += `%0A📍 Address : ${document.getElementById("address").value}`;
                                                                                                                              ...
                                                                                                                              window.open(`https://wa.me/917593925926?text=${msg}`);
